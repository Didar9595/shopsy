...
export default function WishlistPage() {
  ...
  return (
    <div className="">
      ...
      {wishlist.map((p) => (
        <div key={p.product._id} className="bg-white px-6 py-2 rounded shadow">
          <img src={p?.product?.images?.[0]} alt={p.product.title} className="w-45 h-70 object-cover rounded" />
